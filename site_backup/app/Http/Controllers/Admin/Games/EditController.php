...
class EditController extends BaseController
{
    public function page(Game $game)
    {
        ...
        return view('admin.games.edit', compact('game', 'platforms', 'networks'));
    }

    public function save(GameEditRequest $request, Game $game)
    {
        ...
        return redirect()->back()->with('success', trans('app.admin.games.updated'));
    }
}
